...
export async function generateMetadata({ params: { locale } }: EnglishSubtitlePageProps): Promise<Metadata> {
...
export default async function EnglishSubtitlePage({ params: { locale } }: EnglishSubtitlePageProps) {
